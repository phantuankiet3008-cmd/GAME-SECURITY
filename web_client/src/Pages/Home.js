    ...
    <Container fluid="md">
      ...
      <div id="username" className='text-center' style={{marginTop: '5%'}}><br/>
            ...
            <div className='col-md-6 d-flex'>
                <Form.Control style={{backgroundColor: '#292a3e', borderColor: '#191a28', color: 'white', boxShadow: '0px 0px 20px 0px rgba(1,217,118, 0.8)'}} type="email" id="usernameInput" className='col-md-1 offset-md-6 input-user text-white-50' placeholder='Enter Username'/>
